 ...
 * Notifications Model
 *
 * @property \Cake\ORM\Association\BelongsTo $NotificationTexts
 *
...
class NotificationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('NotificationTexts', [
    ...
    {
        $rules->add($rules->existsIn(['notification_text_id'], 'NotificationTexts'));
