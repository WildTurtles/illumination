...
class LanguagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('visiblis_code', 'create')
            ->notEmpty('visiblis_code')
            ->add('visiblis_code', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->isUnique(['visiblis_code']));
