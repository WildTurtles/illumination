<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $semanticCocoonResponse->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $semanticCocoonResponse->id)]
            )
        ?></li>
...
<div class="semanticCocoonResponses form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Semantic Cocoon Response') ?></legend>
        <?php
