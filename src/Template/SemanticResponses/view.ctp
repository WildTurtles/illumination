                ...
                <tr>
                    <td>
                        ...
                        <div style="text-align:center">
                            ...
                            <?php $val = $this->Number->format($semanticResponse->as_title);?>
                            <script type="text/javascript">
                                //     // variables à modifier
                                    ...
                                    var tips_txt= new Array;
                                    tips_txt[1] = "L'affinité sémantique est une mesure de la proximité sémante d'un titre de page WEB avec une requête de recherche. Elle varie de 0 à 100 sur une échelle non lineaire.";
                                    tips_txt[2]="Cette section vous propose une visualisation de l'affichage de votre titre dans les résultats de recherche de Google.";
