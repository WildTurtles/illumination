<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Cocoons Categories'), ['controller' => 'CocoonCategories', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Cocoons Category'), ['controller' => 'CocoonCategories', 'action' => 'add']) ?></li>
...
<div class="semanticCocoons form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Add Semantic Cocoon') ?></legend>
        <?php
            ...
            echo $this->Form->input('cocoon_category_id', ['options' => $cocoonCategories]);
        ?>
    </fieldset>
