...
class LanguagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'visiblis_code' => ['type' => 'string', 'length' => 2, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'timestamp', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        'updated' => ['type' => 'timestamp', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        '_indexes' => [
            'languages_id' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'languages_name' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'languages_visiblis_code_key' => ['type' => 'unique', 'columns' => ['visiblis_code'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => '6df84667-e0b9-4630-bc0a-5dfb92b06a35',
