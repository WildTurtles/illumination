...
class FormatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'visiblis_code' => ['type' => 'string', 'length' => 50, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'formats_id' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
            'formats_name' => ['type' => 'index', 'columns' => ['name'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => '9c541f50-4a15-4ae9-8d49-30fabc4eac97',
            'name' => 'Lorem ipsum dolor sit amet',
            'description' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'created' => 1476658414,
            'updated' => 1476658414,
            'visiblis_code' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
