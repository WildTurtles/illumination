...
/**
 * NotificationTextsFixture
 *
 */
class NotificationTextsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'notification_texts_name' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'uuid' => '78add2bb-6a82-471e-849f-41529d63308e',
