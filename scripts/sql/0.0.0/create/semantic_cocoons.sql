CREATE TABLE semantic_cocoons (
  id                  uuid NOT NULL,
  name                varchar(255),
  cocoon_category_id uuid NOT NULL,
  count               int4,
  url                 text,
  request             text,
  clusters            int2,
...
ALTER TABLE semantic_cocoons ADD CONSTRAINT FKsemantic_c558410 FOREIGN KEY (cocoon_category_id) REFERENCES cocoon_categories (id);
